...
def get_finetune_dataloader(args):
	...
	train_dataset = ImageFolder(root='/data/CUB_200_2011/train/', transform=train_transforms)

	val_dataset = ImageFolder(root='/data/CUB_200_2011/val/', transform=val_transforms)
