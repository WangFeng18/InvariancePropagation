...
class LinearClassifierAlexNet(nn.Module):
	def __init__(self, layer=5, n_label=1000, pool_type='max', cifar=False):
...
class LinearClassifierResNet(nn.Module):
	def __init__(self, layer=6, n_label=1000, pool_type='avg', width=1, bottleneck=True):
